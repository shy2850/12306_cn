...
public class User implements ParseResultSetable,Serializable{
	...
	public User(){}
	public User(Integer id, String name, String password, String email, String id_card, String native_place, Date birth, Boolean sex, Integer type){
		super();
		this.id = id;
		this.name = name;
	...
	public Object parseOf(ResultSet rs) throws SQLException{
		...
		User user = new User(id, name, password, email, id_card, native_place, birth, sex, type);
		return user;
	}
}